...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
		<? $tcb2010_post_has_comments = (get_comments_number() > 0); ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<h2 class="entry-title"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a><?php
			if ($tcb2010_post_has_comments) {
